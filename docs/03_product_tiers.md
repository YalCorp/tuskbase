...
| Local Shared | Heavy solo developer or small local team setup using multiple agents/tools | local daemon, stdio bridge to HTTP MCP | Postgres | text search plus pgvector | robust shared decision memory |
